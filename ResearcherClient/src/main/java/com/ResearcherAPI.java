...
public class ResearcherAPI extends HttpServlet {
	...
	{
		String output = ResearcherObj.insertItem(request.getParameter("researcherName"), 
				 request.getParameter("researcherNIC"), 
				 request.getParameter("researcherAddress"), 
				 request.getParameter("researcherEmail"),
				 request.getParameter("researcherPhoneNo")); 
			...
			throws ServletException, IOException 
	{
		Map paras = getParasMap(request); 
		 ...
		 String output = ResearcherObj.updateItem(paras.get("hidResearcherIDSave").toString(), 
				 ...
				 paras.get("researcherPhoneNo").toString()); 
			...
			throws ServletException, IOException 
	{
		Map paras = getParasMap(request); 
		 ...
		 String output = ResearcherObj.deleteItem(paras.get("researcherID").toString()); 
